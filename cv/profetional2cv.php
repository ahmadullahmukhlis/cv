...
<button id="btn" class="bnt btn-success ">
    ...
    <main>
        <div class="container-fluid" id="pro2">
            ...
            <?php 
                ...
                <div class="col-12" id="contect-info">
                    <table class="table">
                        <tr>
                            <th>gender</th>
                            <td><?php echo $prow['gender']; ?></td>
                            <th>email</th>
                            <td><?php echo $prow['cemail']; ?></td>
                            <th>facebook</th>
                            <td><?php echo $prow['cfacebook']; ?></td>
                        </tr>
                        <tr>
                            <th>birth date</th>
                            <td><?php echo $prow['birthdate']; ?></td>
                            <th>phone</th>
                            <td><?php echo $prow['cphone']; ?></td>
                            <th>address</th>
                            <td><?php echo $prow['caddress']; ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="row" id="cv-body">
                <div class="col-5" id="left-side">
                    <div id="img">
                        <img src="cv/upload-img/<?php echo $prow['cimg']; ?>" alt="" class="img-fluid w-75">
                    </div>
                    <?php }?>
                <div id="porfile">
                <?php 
